    ...
    <div class="container">
      <div class="row justify-content-md-center">
        <div class="col-12 col-md-10 col-lg-8 col-xl-7 col-xxl-6">
          ...
          <p class="mb-5 text-center lead fs-4 secondary-font">
                  ...
                  >
                    <div class="col-11 col-xl-10">
                      <div class="contact-info-wrapper py-4 py-xl-5">
                        ...
                        >
                          En Padelta® siempre buscamos dar un servicio de alta
                          calidad a todos los clientes que se comunican con
                          nosotros. Si estás interasado en nuestros productos o
                          tenés algún tipo de consulta no dudes en contactarnos
                          por medio de alguna de las siguientes opciones.
                        </p>
                      ...
                      <form action="#!">
                        <div class="row gy-4 gy-xl-5 p-4 p-xl-5">
                          ...
                          <div class="col-12 col-md-6">
                            <label for="email" class="form-label secondary-font"
                              >Correo electrónico
                              <span class="text-danger">*</span></label
                            >
                          ...
                          <div class="col-12 col-md-6">
                            <label for="phone" class="form-label secondary-font"
